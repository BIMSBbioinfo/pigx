                              ...
                              ((and (string? tree)
                               ...
                               '(div (@ (id "buttons"))
                                     ...
                                     (a (@ (class "button-big button-light")
                                        ...
                                        "Sample Reports")))
                              ((and (string? tree)
                                    (string=? "DENBI SURVEY HERE" tree))
                               '(div (@ (class "denbi-survey"))
                                     (a (@ (href "https://www.surveymonkey.de/r/denbi-service?sc=rbc&tool=pigx"))
                                        (img (@ (src "images/denbi-logo-color.svg")
                                                (alt "de.NBI logo"))))
                                     (p (strong "Your feedback matters!")
                                        " Take our quick "
                                        (a (@ (href "https://www.surveymonkey.de/r/denbi-service?sc=rbc&tool=pigx"))
