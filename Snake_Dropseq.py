...
# ----------------------------------------------------------------------------- #
# MAPPING
os.path.join(PATH_MAPPED, "{name}", "{genome}", "star_gene_exon_tagged.bam")
...
RULE_ALL = RULE_ALL + DICT
RULE_ALL = RULE_ALL + REFFLAT
RULE_ALL = RULE_ALL + MERGE_FASTQ_TO_BAM
