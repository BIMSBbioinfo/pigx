...
if("--help" %in% args) {
  cat("
      ...
      --qvalue minimum q.value to detect significant differentially methylated bases (default:0.01)
      --difference cutoff for absolute value of methylation percentage change betweeb test and control (default:25)
...
if(!methylDiff.nonempty){ 
  print("There are no differentially methylated cytosines")
  }
