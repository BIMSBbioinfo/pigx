...
if (nrow(approved_mut_plot) > 0){
    ...
    mutations_sig <- robust_reg_mutation_change( changing_muts )
    mutations_sig_unfiltered <- robust_reg_variant_change( changing_muts ) # TODO function structure will be changed, see comments in function file
