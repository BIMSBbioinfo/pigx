...
if ( !(length(coverages.df) == 0)){
    good_samples.df <- coverages.df %>% filter( coverage >= 10) # TODO stringecy should be given by user, maybe even by visualization
    bad_samples.df <- coverages.df %>% filter( coverage < 10)
