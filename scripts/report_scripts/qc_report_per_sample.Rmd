...
coverage_file <- file.path(coverage_dir,paste0(sample_name, "_merged_covs.csv"))
``` 
...
write.csv2(coverage.df, file.path(dirname(coverage_file), "report_download_coverage.csv")) # not sure about the funct of the dataframe here, but it works so I leave it for now
