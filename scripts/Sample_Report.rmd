...
This report was generated with PiGx ChIPseq version 0.0.12.
...
# width of the plot in Peak_Number_in_Genomic_Features_Plot
number_of_peaks   = 0
...
```{r GC_Content_Per sample, include=TRUE, fig.align='center', results='asis'}
gl = list()
